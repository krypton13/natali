window.addEventListener('load', () => {
    ...
    if (isMobile) {
        ...
        playButton.innerText = 'Tap to Play Music';
        ...
        playButton.addEventListener('click', () => {
            ...
            playButton.remove(); // Удаляем кнопку после начала воспроизведения
        });
    } else {
        // Для немобильных устройств начинаем воспроизведение сразу
        document.querySelector('.song').play();
    }
